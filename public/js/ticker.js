(function () {
  ...
  // Add CAPI as last item (DexScreener placeholder-safe)
  ...
  async function fetchCAPI() {
    // Safe placeholder: if DexScreener not available yet, show dash
    try {
      // Replace TOKEN_ADDRESS when available for live price
      const TOKEN_ADDRESS = "";
